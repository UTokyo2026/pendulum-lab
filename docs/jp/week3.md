# Week 3: 高度なモデル化と負荷試験 {#page:w3}

## Week 3 の概要と到達目標 {#w3-overview}
...
- **学生 A:** Task A（負荷の取り付けと実機試験） --- [第[5.3](#sec:w3-task-a)節参照](#sec:w3-task-a)

- **学生 B:** Task B（シミュレーション拡張：車輪ダイナミクス＋摩擦） --- [第[5.4](#sec:w3-task-b)節参照](#sec:w3-task-b)

- **学生 C:** Task C（PID 調整＋高度制御法との比較） --- [第[5.5](#sec:w3-task-c)節参照](#sec:w3-task-c)

## Task A：負荷の取り付けと実機試験（学生A） {#sec:w3-task-a}
...
## Task B：シミュレーション拡張（車輪ダイナミクス + 床面摩擦）（学生B） {#sec:w3-task-b}
...
## Task C：PID 調整とコントローラ比較（学生C） {#sec:w3-task-c}
