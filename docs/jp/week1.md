...
| フォトインタラプタ | 基本回路 |
|---|---|
| ![](../figs/photo_interrupters.png) | ![](../figs/pi_circuit.png) |
...
| 傾斜センサ | モータ＋タイヤ | 完成イメージ |
|---|---|---|
| ![](../figs/angle_sensor.png) | ![](../figs/motor_tire.png) | ![](../figs/assembled.png) |
...
| 新規プロジェクト作成 | サンプルテンプレート選択 | コンパイルボタン |
|---|---|---|
| ![](../figs/fig2026/keil_new_project.png) | ![](../figs/fig2026/keil_editor.png) | ![](../figs/fig2026/keil_build.png) |

*Keil Studio Cloud によるプロジェクト作成とコンパイル*
...
*mbed LPC1768 のピン配置（https://os.mbed.com/platforms/mbed-LPC1768/）*
...
| ブレッドボード | 配線例 |
|---|---|
| ![](../figs/breadboard.png) | ![](../figs/breadboard_sample.png) |
...
| *Schematic View*（回路図）での例 | 対応する *Breadboard View*（ブレッドボード）での配線例 |
|---|---|
| ![](../figs/fig2026/fz2.png) | ![](../figs/fig2026/fz3.png) |
...
| デバッグツール 1: Motor Controller GUI | デバッグツール 2: Analog Input Visualizer |
|---|---|
| ![](../figs/fig2026/debug_motor_controller.png) | ![](../figs/fig2026/debug_analog_visualizer.png) |

*デバッグツール 1 と 2 の Processing GUI 画面*
